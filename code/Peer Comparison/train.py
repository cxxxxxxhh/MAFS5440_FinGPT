...
def main(args):
    ...
    dataset = dataset.remove_columns(
        ['prompt', 'answer',  'symbol',  'exceed_max_length']
    )
...
if __name__ == "__main__":
    ...
    import sys
    sys.argv =[
    'train.py',# This is just a placeholder for the script name
    '--dataset','/home/ychenoy/fingpt-forecaster-dow30-llama_6',
    '--base_model','llama2',
    '--batch_size','2',
    '--learning_rate','1e-4',
    '--num_epochs','8',
    ...
    parser.add_argument("--max_length", default=3600, type=int)
