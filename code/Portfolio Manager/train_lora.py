...
DEFAULT_tokenizer.padding_side = "right"


class GenerationEvalCallback(TrainerCallback):
    
    def __init__(self, eval_dataset, ignore_until_epoch=0, default_tokenizer=None):
    ...
    def on_evaluate(self, args, state: TrainerState, control: TrainerControl, **kwargs):
        ...
        if state.is_local_process_zero:
            ...
            tokenizer = kwargs.get('tokenizer') or self.default_tokenizer
            ...
            for feature in tqdm(self.eval_dataset):
                ...
                inputs = tokenizer(
                    ...
                    padding=False, max_length=4000  # 4096 # 好像是4000
                )
...
def main(args):
    ...
    # load data
    dataset_fname = "/FinGPT_Strategy/" + args.dataset
    # fingpt-forecaster-DOW30-20231203-20241117-1-3-08
    ...
    if args.test_dataset:
        test_dataset_fname = "/FinGPT_Strategy/" + args.test_dataset
    ...
    training_args = TrainingArguments(
        output_dir=f'/FinGPT_Strategy/finetuned_models/{args.run_name}_{formatted_time}', # 保存位置
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run_name", default='strategy-train', type=str)
    parser.add_argument("--dataset", default='fingpt-forecaster-strategy-20231203-20241117-1-3-08', type=str)
    parser.add_argument("--test_dataset", type=str)
    parser.add_argument("--base_model", default='llama2', type=str, choices=['chatglm2', 'llama2'])
    parser.add_argument("--max_length", default=3072, type=int)# 2048, 930, 368|4096 
    ...
    parser.add_argument("--ds_config", default='/FinGPT_Strategy/config.json', type=str)
