...
from indices import *
from data import  prepare_data_for_symbol, query_gpt4, create_dataset, get_all_infos
...
def main(args):
    ...
    data_dir = f"/FinGPT_Strategy/data/{index_name}_{start_date}_{end_date}"
    ...
    #get_all_infos(index, data_dir, start_date, end_date, min_past_weeks=1, max_past_weeks=1, with_basics=with_basics)
...
if __name__ == "__main__":
    ...
    ap.add_argument("--start_date", default="2023-11-20", help="start date")
    ap.add_argument("--end_date", default="2024-11-20", help="end date")
