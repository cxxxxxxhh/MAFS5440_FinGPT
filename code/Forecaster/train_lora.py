...
def main(args):
    ...
    # load data
    dataset_fname = "/fintech_project3/data/" + args.dataset
    ...
    if args.test_dataset:
        test_dataset_fname = "/fintech_project3/data/" + args.test_dataset
    ...
    training_args = TrainingArguments(
        output_dir=f'/FinGPT_Forecaster/finetuned_models/{args.run_name}_{formatted_time}', # 保存位置
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default='fingpt-forecaster-dow-30-20231120-20241120-1-4-06', type=str)
    parser.add_argument("--test_dataset", type=str)
    parser.add_argument("--base_model", default='llama2', type=str, choices=['chatglm2', 'llama2'])
    parser.add_argument("--max_length", default=4096, type=int)# 本来是512 |2048, 930, 368|4096 
    ...
    parser.add_argument("--ds_config", default='/FinGPT_Forecaster/config.json', type=str)
