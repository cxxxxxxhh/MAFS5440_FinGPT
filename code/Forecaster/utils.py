...
def parse_model_name(name, from_remote=False):
    ...
    if name == 'chatglm2':
        ...
        return '/checkpoints/Llama-2-7b-chat-hf' # if from_remote else 'base_models/Llama-2-7b-chat-hf'
    else:
...
def load_dataset(names, from_remote=False):
    ...
    for name in dataset_names:
        ...
        if not os.path.exists(name):
            ...
            name = ('FinGPT/fingpt-forecaster-' if from_remote else '/data/') + name.split('*')[0]
